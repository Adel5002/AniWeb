...
class AnimeListView(ListView):
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        ...
        if page:
            ...
            self.request.session['current_page'] = page
        else:
...
class AnimeDetail(DetailView, AnimeListView):
    model = None
    ...
    def get(self, request, ide):
        ...
        return render(request, self.template_name, data_list)
